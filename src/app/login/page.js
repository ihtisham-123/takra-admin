...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white">
      {/* Top Banner */}
      ...
      <div className="relative z-10 w-full max-w-md mx-4 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 tracking-wide">Welcome Back</h1>
          <p className="text-gray-500 text-sm mt-1">Sign in to UCP TAAKRA</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-gray-200 rounded-2xl p-8 shadow-xl shadow-red-900/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-red-900 to-red-800 text-white font-medium rounded-xl shadow-lg shadow-red-900/20 hover:from-red-800 hover:to-red-700 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:ring-offset-2 transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-6 pt-5 border-t border-gray-200 text-center">
            <p className="text-gray-500 text-sm">
              ...
              <Link href="/signup" className="text-red-800 hover:text-red-700 font-medium transition-colors">
                Sign up
              </Link>
            </p>
          </div>
